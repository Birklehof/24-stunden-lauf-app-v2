...
export default function Menu({ navItems }: MenuProps) {
  ...
  return (
    <>
      <div className="menu rounded-box menu-horizontal absolute bottom-3 left-1/2 z-40 -translate-x-1/2 bg-base-100 p-2 shadow-xl lg:bottom-1/2 lg:left-2 lg:translate-x-0 lg:translate-y-1/2 lg:gap-2 lg:menu-vertical">
